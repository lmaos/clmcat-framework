...
public class GroupMap {
	...
	/**
	 *
	 * @param exec 设置并行执行的线程池
	 */
	public GroupMap(ExecutorService exec) {
		this(exec, false);
	}
	 ...
	 *
	 * @param exec
	 * @param canDestroy true, 当调用 destroy时候线程池会被销毁。
	 */
	public GroupMap(ExecutorService exec, boolean canDestroy) {
		this.exec = exec;
		this.canDestroy = canDestroy;
	}

	public GroupMap(int poolSize) {
		if (poolSize < 0) {
		...
		if (poolSize == 0) {
			...
			exec = Executors.newFixedThreadPool(poolSize, tf);
		}
	...
	/// 当传入自定义线程时，需要被销毁时候传入。 需要先设置能被销毁。
	public GroupMap canDestroy() {
		this.canDestroy = true;
		return this;
	}
	 ...
	 * @return
	 */
	public <T> List<List<T>> groupList(Iterable<T> srcList, int itemLength) {
	...
	public <I,B> Map<I, Integer> groupCountSize(Iterable<B> srcList, Function<B, I> indexFunction) {
	...
	public <I,B> Map<I, Long> groupCountLongValue(Iterable<B> srcList, Function<B, I> indexFunction, Function<B, Long> valueFunction) {
	...
	public <I,B> Map<I, Integer> groupCountIntValue(Iterable<B> srcList, Function<B, I> indexFunction, Function<B, Integer> valueFunction) {
		Map<I, Integer> map = new HashMap<I, Integer>();
		for (B bean : srcList) {
			// 分组索引
			I indexKey = indexFunction.apply(bean);	
	...
	public <I,B> Map<I, BigDecimal> groupCountBigDecimalValue(Iterable<B> srcList, Function<B, I> indexFunction, Function<B, BigDecimal> valueFunction) {
	 ...
	 * @return
	 */
	public <I,B,R> Map<I, List<R>> group(Iterable<B> srcList, Function<B, I> indexFunction, Function<B, R> resultFunction) {
	 ...
	 * @return
	 */
	public <I,B,R> Map<I, List<R>> groups(Iterable<B> srcList, Function<B, List<I>> indexFunction, Function<B, R> resultFunction) {
		Map<I, List<R>> map = new HashMap<I, List<R>>();
		for (B bean : srcList) {
			// 分组索引
	 ...
	 * @return
	 */
	public <I,B> Map<I, List<B>> group(Iterable<B> srcList, Function<B, I> indexFunction) {
	...
	public <I, B, R> Map<I, R> groupOne(Iterable<B> srcList, Function<B, I> indexFunction, Function<B, R> resultFunction) {
	 ...
	 * @return
	 */
	public <I, B, R> Map<I, R> groupOne(Collection<B> srcList, Function<B, I> indexFunction, Function<B, R> resultFunction) {
		return groupOne((Iterable<B>)srcList, indexFunction, resultFunction);
	}
	
	public <I,B> Map<I, B> groupOne(Iterable<B> srcList, Function<B, I> indexFunction) {
	 ...
	 * @return
	 */
	public <I,B> Map<I, B> groupOne(Collection<B> srcList, Function<B, I> indexFunction) {
	 ...
	 * @return
	 */
	public <I,B> Map<I, List<B>> groups(Iterable<B> srcList, Function<B, List<I>> indexFunction) {
		Map<I, List<B>> map = new HashMap<I, List<B>>();
		for (B bean : srcList) {
			// 分组索引
			List<I> indexKeys = indexFunction.apply(bean);
	 ...
	 * @return
	 */
	public <I,B,R> Map<I, List<R>> group(Collection<B> srcList, Function<B, I> indexFunction, Function<B, R> resultFunction) {
	 ...
	 * @return
	 */
	public <I,B> Map<I, List<B>> group(Collection<B> srcList, Function<B, I> indexFunction) {
	 ...
	 * @return
	 */
	public <I0,I1,B> Map<I0, Map<I1,List<B>>> groupMulti(Collection<B> srcList, Function<B, I0> indexFunction0, Function<B, I1> indexFunction1) {
	 ...
	 * @return
	 */
	public <I0, I1, B, R> Map<I0, Map<I1,R>> groupMultiOne(Collection<B> srcList, Function<B, I0> indexFunction0, Function<B, I1> indexFunction1, Function<B, R> resultFunction) {
	...
	public <I0, I1, B> Map<I0, Map<I1, B>> groupMultiOne(Collection<B> srcList, Function<B, I0> indexFunction0, Function<B, I1> indexFunction1) {
	 ...
	 * @return
	 */
	public <I0,I1,B, R> Map<I0, Map<I1,List<R>>> groupMulti(Collection<B> srcList, Function<B, I0> indexFunction0, Function<B, I1> indexFunction1, Function<B, R> resultFunction) {
	 ...
	 * @return
	 */
	public <I0,I1,I2,B> Map<I0, Map<I1,Map<I2, List<B>>>> groupMulti3(Collection<B> srcList, Function<B, I0> indexFunction0, Function<B, I1> indexFunction1, Function<B, I2> indexFunction2) {
	 ...
	 * @return
	 */
	public <I0,I1,I2,B, R> Map<I0, Map<I1,Map<I2, List<R>>>> groupMulti3(Collection<B> srcList, Function<B, I0> indexFunction0, Function<B, I1> indexFunction1, Function<B, I2> indexFunction2, Function<B, R> resultFunction) {
	 ...
	 * @return
	 */
	public <K,V,T> Map<K, V> groupListParallelToMap(Iterable<T> srcList, int itemLength, Function<List<T>, Map<K,V>> groupExec) {
	 ...
	 * @return
	 */
	public <K,V,T> Map<K, V> groupListParallelToMaps(Iterable<T> srcList, int itemLength, Function<List<T>, Map<K,V>> groupExec) {
		Map<K, V> map = new HashMap<K, V>();
		List<List<T>> groupList = groupList(srcList, itemLength);
		if (groupList.size() == 0) {
			return map;
	 ...
	 * @return
	 */
	public <T> AsyncFuture groupListParallelExec(Iterable<T> srcList, int itemLength, Consumer<List<T>> groupExec) {
		List<List<T>> groupList = groupList(srcList, itemLength);
		if (groupList.size() == 0) {
	 ...
	 * @param groupExec
	 */
	public <K, V> AsyncFuture groupMapParallelExec(Map<K, V> srcMap, BiConsumer<K,V> groupExec) {
		if (srcMap.size() == 0) {
			return new AsyncFuture();
		}
		//
	...
	/** 分组List转为Map集合 (非并行执行.). 
	 * 如果并行请使用 :  {@link GroupMap#groupListParallelToMap(Iterable, int, Function) } 
	 */
	public <K,V,T> Map<K, V> groupListToMap(Iterable<T> srcList, int itemLength, Function<List<T>, Map<K,V>> groupExec) {
		Map<K, V> map = new HashMap<K, V>();
	...
	public String join(List<? extends GroupKey> groupKeys, String split, String groupAround) {
		return join(groupKeys, split, groupAround, null, "?");
	}
	
	public String join(List<? extends GroupKey> groupKeys, String split, String groupAround, String itemAround) {
	 ...
	 * @return
	 */
	public String join(List<? extends GroupKey> groupKeys, String split, String groupAround, String itemAround, String aroundChar) {
