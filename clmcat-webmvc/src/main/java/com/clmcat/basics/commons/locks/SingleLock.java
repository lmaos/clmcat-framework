package com.clmcat.basics.commons.locks;
...
import com.clmcat.basics.commons.locks.LockConsumerWrapper.LockCallback;
import com.clmcat.basics.commons.locks.LockConsumerWrapper.LockComsumer;
import com.clmcat.basics.commons.locks.LockConsumerWrapper.LockComsumerNotThrows;
import com.clmcat.basics.commons.locks.LockConsumerWrapper.LockConsumerCallback;
import com.clmcat.basics.commons.locks.LockConsumerWrapper.LockExecutor;
import com.clmcat.basics.commons.locks.LockConsumerWrapper.LockExecutorrNotThrows;
...
public class SingleLock {
	...
	public <T>T synchronizedLock(LockConsumerCallback callback) throws Exception {
		try {
			lock.lock();
			return (T)callback.exec(await);
		} finally {
			lock.unlock();
		}
	}
